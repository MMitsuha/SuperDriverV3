...
DATA_LIST_ENTRY g_KillKeyList = { 0 };

//-------------------------------------

PVOID g_FileCallbackHandle = NULL;
DATA_LIST_ENTRY g_ProtDirList = { 0 };
DATA_LIST_ENTRY g_ProtFileList = { 0 };

//------------------------------------

PVOID g_ProcKillCallbackHandle = NULL;
DATA_LIST_ENTRY g_KillProcList = { 0 };
DATA_LIST_ENTRY g_ProtProcList = { 0 };
BOOLEAN g_KillAllProc_Switch = FALSE;

//------------------------------------

BOOLEAN g_KillAllSys_Switch = FALSE;
DATA_LIST_ENTRY g_KillSysList = { 0 };
BOOLEAN g_KillAllDll_Switch = FALSE;
DATA_LIST_ENTRY g_KillDllList = { 0 };
